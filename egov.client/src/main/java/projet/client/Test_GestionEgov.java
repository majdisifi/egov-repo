...
public class Test_GestionEgov {
	 ...
	 */
	/*
	 * @Test public void test1() { Context context;
	 * 
	 * try { context = new InitialContext();
	 * 
	 * IGreyCardManagementRemote ge = (IGreyCardManagementRemote) context
	 * .lookup(
	 * "egov.ejb/GreyCardManagement!sessionbeans.IGreyCardManagementRemote");
	 * 
	 * GreyCard GreyCard = new GreyCard(); GreyCard.setIdGreyCard(1);
	 * GreyCard.setCategory("mmm"); GreyCard.setConstructor("jjjjj");
	 * GreyCard.setCar(null); GreyCard.setNumImmatriculation(5666);
